<option value="{{getSetting('default_country')}}">{{getSetting('default_country')}}</option>
...
<option
  value="South Georgia and The South Sandwich Islands">{{__('South Georgia and The South Sandwich Islands')}}</option>
