...
<body>
<div style="margin: 0 !important; padding: 0 !important;" role="article" aria-roledescription="email" aria-label="Welcome" lang="en">
                              ...
                              <td style="padding-top: 0; padding-right: 0; padding-bottom: 0; padding-left: 0; height: 1px;">
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" style="width: 100%; margin-top: 10px">
                                  ...
                                  <tr>
                                    ...
                                    >
                                      <div>
                                        <div><span style="font-size: 18px;">Bonjour Akai ōkami. J'espère que vous allez bien.&nbsp;</span></div>
                                        <div><br /></div>
                                        <div>
                                          <span style="font-size: 18px;">Hello, <span style="color: #0262d0">{{$user->name}}!</span></span>
                                        </div>
                                        <div><br /></div>
                                        <div><span style="font-size: 18px;">Welcome to {{getSetting('site_name')}}!nbsp;</span></div>
                                        <div><br /></div>
                                        <div><span style="font-size: 18px;">Your {{getSetting('site_name')}} account has been successfully created.</span></div>
                                        <div><br /></div>
                                      </div>
                                    </td>
                                  </tr>
                                ...
                                <table role="presentation" cellpadding="0" cellspacing="0" align="center" width="100%" style="width: 100%; margin-top: 10px; margin-bottom: 20px;">
                                  ...
                                  <tr>
                                    <td align="center">
                                      <div>
                                        <a
                                          href="{{getSetting('site_url')}}/confirm/email/{{$user->email_confirmation_code}}"
                                          style="
                                                                                                                        display: inline-block;
